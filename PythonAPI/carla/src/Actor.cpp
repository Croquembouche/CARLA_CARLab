...
void export_actor() {
  ...
  class_<cc::WalkerAIController, bases<cc::Actor>, boost::noncopyable, std::shared_ptr<cc::WalkerAIController>>("WalkerAIController", no_init)
    ...
    .def("get_navigation_path", +[](cc::WalkerAIController &self, const cg::Location &destination) { return StdVectorToPyList(self.GetNavigationPath(destination)); }, (arg("destination")))
